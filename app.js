...
const QS = [
  ...
  {k:'La loro vita insieme', h:'La frase che ha rotto il ghiaccio.', t:'Con quale battuta Ste ha conquistato il cuore di Mara?', o:['POP fa il criceto. E 1000 altri modi per usare il microonde','Vuoi vedere il mio trucco con le bilance?','Ti va di andare a correre insieme?','Sai che assomigli a mia cugina?'], c:0, s:'POP fa il criceto. E 1000 altri modi per usare il microonde: da lì non si è più tornati indietro.'},
